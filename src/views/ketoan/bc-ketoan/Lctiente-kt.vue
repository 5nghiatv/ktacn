...
export default {
  ...
  methods: {
    ...
    testValidator(field) {
      if (field == 'maso')
        return (this.Validator.maso = this.lctiente.maso != '')
      if (field == 'chitieu')
        return (this.Validator.chitieu = this.lctiente.chitieu != '')
      if (field == 'cachtinh')
        return (this.Validator.cachtinh = this.lctiente.cachtinh != '')
      let passe =
    ...
    createTodo() {
      ...
      apiService
        .createTodo(this.model, this.lctiente)
        .then((r) => {
          if (r.status === 201) {
    ...
    updateTodo() {
      ...
      apiService
        .updateTodo(this.model, lctiente.id, lctiente)
        .then((r) => {
          if (r.status === 200) {

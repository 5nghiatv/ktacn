<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-button v-waves :loading="downloadLoading" class="filter-item" type="primary" icon="el-icon-download" @click="handleDownloadZip">
        Zip
      </el-button>
      <el-checkbox v-model="showReviewer" class="filter-item" style="margin-left:15px;" @change="tableKey=tableKey+1">
        reviewer
      </el-checkbox>
      <el-checkbox v-model="inlineEdit" class="filter-item" style="margin-left:15px;" >
        Inline-Edit
      </el-checkbox>
...
<!-- ----------------------- -->
      <el-table-column  v-if = "inlineEdit" min-width="300px" label="Title">
        <template slot-scope="{row}">
...
<!-- ----------------------- -->
      ...
      <el-table-column  v-if = "!inlineEdit" label="Title" min-width="145px">
        <template slot-scope="{row}">
      ...
      let list = [
          {
            ...
            title: "1 Tnpdnf Sifvr Msummr Wskprm Kpuxv",
            type: "US",
            author: 'Ronald',
          ...
          {
            display_time: new Date(),
            title: "2 Tnpdnf Sifvr Msummr Wskprm Kpuxv",
            type: "CN",
            author: 'Ronald 2',
            content: `<p>I am testing data, I am testing data.</p><p><img src="https://wpimg.wallstcn.com/4c69009c-0fd4-4153-b112-6cb53d1cf943"></p>`,
            content_short: "mock data",
          ...
          {
            display_time: new Date(),
            title: "3 Tnpdnf Sifvr Msummr Wskprm Kpuxv",
            type: "JP",
            author: 'Ronald 3',
            content: `<p>I am testing data, I am testing data.</p><p><img src="https://wpimg.wallstcn.com/4c69009c-0fd4-4153-b112-6cb53d1cf943"></p>`,
            content_short: "mock data",
        ...
        let mockList = list.filter(item => {
          ...
          if (lq.title && item.title.indexOf( lq.title) < 0) return false
          return true
        })
        ...
        return new Promise((resolve, reject) => {
            if (true) {
              return resolve( { list: pageList , total: mockList.length });
            } else {
